...
from pages.kiosk_forms_pg import KioskForms
from selenium import webdriver
import time
import pytest

class TestKioskForms:
    ...
    def class_object_setup(self):
        ...
        self.kf = KioskForms(self.driver)
    ...
    def test_kiosk_features(self):
        ...
        time.sleep(3)
        self.kf.kiosk_initial_setup()
        self.kf.kiosk_send_and_close_button()
        time.sleep(2)
        self.kf.verify_form_sent_to_kiosk()