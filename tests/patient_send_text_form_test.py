...
from pages.patient_send_text_form import PatientTextForm
...
class TestEmailForms:
    ...
    def class_object_setup(self):
        ...
        self.ptf = PatientTextForm(self.driver)
    ...
    def test_kiosk_features(self):
        ...
        time.sleep(1)
        self.ptf.patient_option_radio()
        self.ptf.text_patient_option()
        self.ptf.send_btn()
        #time.sleep(1)
        self.ptf.verify_form_sent()